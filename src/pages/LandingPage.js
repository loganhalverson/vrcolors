		...
		<>
			<div className="overflow-hidden">
				...
				<div className="flex flex-col lg:hidden">
					{/* Fixed Background */}
					<div className="fixed -z-10 m-auto min-h-screen w-full bg-gradient-to-b from-blue-950 to-gray-950 saturate-[80%] filter" />

					<Navbar />

					<div className="flex w-full flex-col items-center justify-between px-6 ">
						<div className="col-span-5 col-start-6 flex max-h-screen items-center justify-center">
							<video
								width="600"
								height="100%"
								autoPlay
						...
						<h1 className="text-center text-4xl leading-tight tracking-tight text-white">
							Build your new favorite menu theme.
						</h1>
						<Link
							to={'/color/6BE4F9-2AABC1-0D3537-1B222C-BBBBBB-008489'}
