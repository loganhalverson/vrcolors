		...
		<div className="flex items-center justify-center">
			<div className="flex flex-wrap items-center justify-center gap-x-8">
				...
				<a
					...
					className="block text-neutral-100 transition hover:text-blue-600"
				>
					<svg xmlns="http://www.w3.org/2000/svg" className="aspect-square h-16 w-16" viewBox="0 0 24 24">
						<path
							fill="currentColor"
				...
				<div className="group relative">
					<p className="block text-neutral-100 transition hover:text-blue-600">
						<svg xmlns="http://www.w3.org/2000/svg" className="aspect-square h-16 w-16" viewBox="0 0 24 24">
							<path
								fill="currentColor"
					...
					<span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-12 scale-0 rounded-lg bg-gray-950 px-2 py-1 text-center text-gray-50 transition group-hover:-translate-y-[4.5rem] group-hover:scale-100">
						@biscuitbasket.
					</span>
				</div>
				...
				{/* VRC */}
				<a
					href="https://vrchat.com/home/user/usr_ff8ccfd8-d9f2-425a-8c6f-017da35f7153"
					className="block text-neutral-100 transition hover:text-blue-600"
				>
					<svg xmlns="http://www.w3.org/2000/svg" className="aspect-square h-16 w-16" viewBox="0 0 16 16">
						<path
							fill="currentColor"
